...
#[tracing::instrument(skip_all, fields(code = ?LogCode::BAT005, event = "回合开始"), target = "combat")]
...
#[tracing::instrument(skip_all, fields(code = ?LogCode::BAT006, event = "回合结束"), target = "combat")]
