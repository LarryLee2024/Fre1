...
use super::foundation::LocaleId;
use super::io::load_all_ftl_system;
use super::storage::{
    LocalizationDatabase, LocalizedTextCache, detect_locale_change_and_clear_cache,
};
use super::ui::render_localized_text;
use super::validation::{AuditTimer, audit_system, validation_system};
...
impl LocalizationPlugin {
    ...
    pub fn new() -> Self {
        ...
        let default_locale = LocaleId::ZzZZ;

        #[cfg(not(feature = "fake-locale"))]
        let default_locale = LocaleId::EnUS;
...
impl Plugin for LocalizationPlugin {
    fn build(&self, app: &mut App) {
        ...
        {
            let watcher = super::io::create_locale_watcher();
            app.insert_non_send(watcher);
            app.add_systems(Update, super::io::hot_reload_system);
        }
    }
}
