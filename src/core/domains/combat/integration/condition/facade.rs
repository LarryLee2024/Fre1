...
impl CombatConditionFacade {
    ...
    pub fn check_effect_immunity(
        ...
        check_immunity(context, effect_type, entity, commands)
    }
    ...
    pub fn evaluate_condition(
        ...
        evaluate(condition, context, entity, commands)
    }
    ...
    pub fn check_casting_conditions(
        ...
        let result = evaluate(&silence_check, context, entity, commands);
        if !result.is_passed() {
            return result;
        }
        ...
        let result = evaluate(&paralyze_check, context, entity, commands);
        if !result.is_passed() {
            return result;
        }
