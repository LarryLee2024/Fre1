...
fn register_root_tag_succeeds() {
    ...
    let def = make_tag("tag_000001", None, 0, TagNamespace::Damage, true);
...
fn register_child_tag_succeeds() {
    ...
    hierarchy
        .register(
            make_tag("tag_000001", None, 0, TagNamespace::Damage, true),
            &mut commands,
        )
        .unwrap();
    hierarchy
...
fn duplicate_id_rejected() {
    ...
    let result = hierarchy.register(
        make_tag("tag_000001", None, 1, TagNamespace::Damage, true),
        &mut commands,
    );
