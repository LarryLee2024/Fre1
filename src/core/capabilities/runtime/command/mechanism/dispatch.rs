...
mod tests {
    ...
    #[test]
    fn unit_041_dispatch_unhandled() {
    ...
    #[test]
    fn unit_043_validate_move_unit() {
        let cmd = GameCommand::MoveUnit {
            unit_id: "".into(),
            path: vec!["0,0".into()],
        };
    ...
    #[test]
    fn unit_046_validate_cast_spell() {
    ...
    #[test]
    fn unit_048_validate_meta_commands() {
