...
mod tests {
    use super::*;
    use crate::core::capabilities::runtime::pipeline::foundation::types::{
        FailureStrategy, PipelineStep,
    };

    #[test]
    fn unit_020_definition_creation() {
    ...
    #[test]
    fn unit_021_definition_find_stage() {
    ...
    #[test]
    fn unit_022_state_initial() {
        let def = PipelineDefinition::new("combat");
        let state = PipelineState::new(&def);
    ...
    #[test]
    fn unit_023_state_advance() {
        let def = PipelineDefinition::new("combat");
        let mut state = PipelineState::new(&def);
