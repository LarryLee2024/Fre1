...
mod tests {
    ...
    #[test]
    fn unit_050_recording_session_lifecycle() {
    ...
    #[test]
    fn unit_051_recording_stop_not_recording() {
        let mut session = RecordingSession::new(60);
    ...
    #[test]
    fn unit_052_frame_checksum_calculation() {
    ...
    #[test]
    fn unit_053_frame_checksum_deterministic() {
        let mut frame = ReplayFrame::new(0, 100);
        frame.add_command(ReplayCommand::SkipTurn { unit: "u1".into() });
    ...
    #[test]
    fn unit_056_validate_version_ok() {
        assert!(validate_version(1, 2).is_ok());
        assert!(validate_version(1, 1).is_ok());
    }

    #[test]
    fn unit_057_validate_version_mismatch() {
        assert_eq!(
    ...
    #[test]
    fn unit_058_checksum_different_content_different_hash() {
