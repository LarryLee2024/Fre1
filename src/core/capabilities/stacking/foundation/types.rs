...
mod tests {
    ...
    #[test]
    fn unit_001_stacking_type_name() {
    ...
    #[test]
    fn unit_002_stacking_type_tracks_layers() {
    ...
    #[test]
    fn unit_005_config_aggregate_rejects_low_max() {
        let result = StackingConfig::aggregate(1, false);
        assert!(result.is_err());
    }

    #[test]
    fn unit_006_config_refresh() {
    ...
    #[test]
    fn unit_010_stack_identity_with_ability() {
    ...
    #[test]
    fn unit_011_stack_match_result_variants() {
    ...
    #[test]
    fn unit_012_stacking_decision_display() {
    ...
    #[test]
    fn unit_014_config_default_is_none() {
