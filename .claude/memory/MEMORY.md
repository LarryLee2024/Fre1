...
- [picking-refactor-phase-2-3](project-picking-refactor-phase-2-3.md) — Picking refactor: event-driven projections, camera via CameraRequest, removed old entity observers + println
