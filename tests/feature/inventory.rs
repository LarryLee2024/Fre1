...
//! ✅ 使用标准数据 — 使用自定义物品定义（inventory 测试关注物品转移，非单位属性）
...
// ══════════════════════════════════════════════════════════════
// INV-IT-001: 容器间转移物品 — 从 A 转移 5 瓶到 B
// ══════════════════════════════════════════════════════════════

/// INV-IT-001: 容器间转移物品 — 从 A 转移 5 瓶到 B
///
/// Given: 两个空背包 A/B，A 中放入 10 瓶治疗药水
/// When:  从 A 转移 5 瓶到 B
...
// ══════════════════════════════════════════════════════════════
// INV-IT-002: 目标容器满时转移失败 — 物品留在源容器
// ══════════════════════════════════════════════════════════════

/// INV-IT-002: 目标容器满时转移失败 — 物品留在源容器
///
/// Given: 背包 A 有 10 瓶药水，宝箱 B 容量=1 已满
/// When:  从 A 尝试转移 5 瓶到 B
/// Then:  A 仍为 10 瓶，B 仍为 1 瓶（转移未发生）
#[test]
