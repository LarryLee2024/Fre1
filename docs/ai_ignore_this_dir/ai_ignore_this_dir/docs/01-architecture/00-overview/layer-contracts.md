...
详细设计见 `docs/01-architecture/00-overview/app-bootstrap.md` 和 `docs/01-architecture/00-overview/plugin-design.md`。
...
详细设计见 `docs/01-architecture/09-infrastructure-migration/infrastructure-design.md`。
...
详细设计见 `docs/01-architecture/08-i18n-modding-collaboration/modding-design.md`。
...
详见 `docs/01-architecture/README.md` 中"UI 架构"部分。
...
参照 `docs/01-architecture/04-events-logging-error/error-architecture.md` 完整规范。此处简述：
...
🟥 **GameResult 不应定义在 shared/ 层**。详见 `docs/01-architecture/04-events-logging-error/error-architecture.md` 迁移计划。每层定义自己的 Result 别名：
