...
> **优化来源**: `docs/architecture/feature_flag_design.md`
...
> **优化来源**: `docs/architecture/feature_flag_design.md` §8.2
...
> **优化来源**: docs/architecture/feature_flag_design.md §7.1 — Core 层绝对纯洁性
...
> **优化来源**: docs/architecture/feature_flag_design.md §2.3 — 默认配置策略
...
> **优化来源**: docs/architecture/feature_flag_design.md §8.1 — 各层允许的 Feature Flag
...
> **优化来源**: docs/architecture/feature_flag_design.md §7.2 — Feature Hell 防护
