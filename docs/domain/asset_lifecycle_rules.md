...
> **优化来源**: docs/architecture/asset_lifecycle_rules.md — 品红色棋盘格规则：明确的视觉标识，一眼可辨认缺失资源
- 禁止无限重试
...
> **优化来源**: docs/architecture/asset_lifecycle_rules.md — AssetUnloadQueue 分帧卸载实现细节
...
> **优化来源**: docs/architecture/asset_lifecycle_rules.md — SafeAssetRef 重新验证机制，避免缓存过期
...
> **优化来源**: docs/architecture/asset_lifecycle_rules.md — SRPG 动画分级管理、技能 VFX 按需加载策略
...
> **优化来源**: docs/architecture/asset_lifecycle_rules.md — 设备差异化内存预算、DeviceProfile 检测机制
