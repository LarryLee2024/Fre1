...
> **优化来源**: `docs/architecture/config_system_design.md` §4.1 — 锁范围从 GameRulesConfig 扩展到 ALL 配置，AppState::InGame 替代 BattleState::Running
...
> **优化来源**: `docs/architecture/config_system_design.md` §5.3 — 按配置类型分级处理加载失败
...
> **优化来源**: `docs/architecture/config_system_design.md` §2.2 — 反"上帝配置"：按领域拆分为细粒度独立 Resource
...
> **优化来源**: `docs/architecture/config_system_design.md` §2.3 — 防抖窗口从"1-2秒"精确为 200ms
...
> **优化来源**: `docs/architecture/config_system_design.md` §4.1 — 热重载事件风暴缓解
...
> **优化来源**: `docs/architecture/config_system_design.md` §6 — 明确 Patch（深度合并）vs Override（整体替换）语义差异
...
> **优化来源**: `docs/architecture/config_system_design.md` §4.1 — 锁范围从 GameRulesConfig 扩展到 ALL 配置
...
> **优化来源**: `docs/architecture/config_system_design.md` §2.3 — 防抖窗口精确为 200ms
