...
> **优化来源**: docs/architecture/command_bus_design.md — Memento 模式替代手写 undo()
...
> **优化来源**: docs/architecture/command_bus_design.md — 将 Box\<dyn Command\> 重构为可序列化枚举
...
> **优化来源**: docs/architecture/command_bus_design.md — 放弃反向操作 undo，改用状态快照
...
> **优化来源**: docs/architecture/command_bus_design.md — Memento 模式：代码量减少 80%，绝对可靠
...
> **优化来源**: docs/architecture/command_bus_design.md — Command Bus 核心执行必须声明为 Exclusive System

---

## Cursor-based 执行（游标执行）

> **优化来源**: docs/architecture/command_bus_design.md — 游标指针追踪执行位置，支持断点恢复和分段执行
...
> **优化来源**: docs/architecture/command_bus_design.md — 游标执行模型：断点恢复、分段执行、重放支持

---

## ActionQueue（效果执行队列）

> **优化来源**: docs/architecture/command_bus_design.md §18 — ActionQueue 顺序执行队列
...
> **优化来源**: docs/architecture/command_bus_design.md §18 — ActionQueue 链式执行：DamageAction → BuffAction → DeathCheckAction → CounterAttackAction

---

## 三大基本命令类型

> **优化来源**: docs/architecture/command_bus_design.md §13 — SRPG 核心操作覆盖
...
> **优化来源**: docs/architecture/command_bus_design.md — CommandQueue::execute 接收 &mut World，必须在 Exclusive System 中
...
> **优化来源**: docs/architecture/command_bus_design.md — Command Pattern → Replay / AI / 联机直接受益
...
> **优化来源**: docs/architecture/command_bus_design.md — 编译时类型安全，支持 Reflect + serde
...
> **优化来源**: docs/architecture/command_bus_design.md — 代码量减少 80%，绝对可靠
...
> **优化来源**: docs/architecture/command_bus_design.md — &mut World 独占访问要求
...
> **优化来源**: docs/architecture/command_bus_design.md — Effect Pipeline 连锁反应使手写反向操作不可行
