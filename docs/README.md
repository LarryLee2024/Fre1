...
├── 02-domain/             领域——31 个领域规则（15 Capabilities + 15 Domains + 1 UI）
...
├── 06-ui/                  UI——L3 表现层架构（Widget/Screen/Projection/Theme）
├── 07-operations/         运维——部署、CI/CD、环境配置
├── 08-knowledge/          知识——项目知识库、决策记录
...
| 查业务规则 | `02-domain/README.md`（31 个领域规则索引） |
| 查数据 Schema | `04-data/README.md`（30+ Schema 文件） |
| 查 Content Def | `03-content/README.md`（5 层 31 Def） |
| 查 UI 架构 | `06-ui/README.md`（14 文件 5 子目录） |
