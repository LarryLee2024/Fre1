...
来源：`docs/其他/32.国际化.md`、`docs/其他/33..md`、`docs/其他/52.md`、`docs/01-architecture/infrastructure-design.md`、`docs/01-architecture/content-pipeline.md`、`docs/01-architecture/modding-design.md`
...
参见 `docs/01-architecture/content-pipeline.md` § Rule/Content 分离。
