...
- `docs/02-domain/ability_domain.md` — Ability 领域规则
- `docs/02-domain/effect_domain.md` — Effect 领域规则
- `docs/02-domain/execution_domain.md` — Execution 领域规则
- `docs/02-domain/targeting_domain.md` — Targeting 领域规则
