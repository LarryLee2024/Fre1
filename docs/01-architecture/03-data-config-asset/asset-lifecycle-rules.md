---
id: 01-architecture.asset-lifecycle-rules
...
交叉引用：
- `docs/01-architecture/03-data-config-asset/asset-organization.md` — 资源目录组织与美术工作流
- `docs/01-architecture/09-infrastructure-migration/infrastructure-design.md` — Infrastructure 层资源加载模块设计
- `docs/01-architecture/README.md` — 资源与内容生产总纲
