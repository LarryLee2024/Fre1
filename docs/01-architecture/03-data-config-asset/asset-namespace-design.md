...
交叉引用：
- `docs/01-architecture/08-i18n-modding-collaboration/modding-design.md`、`docs/01-architecture/00-overview/project-structure.md`、`docs/01-architecture/00-overview/layer-contracts.md`
