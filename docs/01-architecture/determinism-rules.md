---
id: 01-architecture.determinism-rules
...
| 文档 | 关系 |
|------|------|
| `docs/02-domain/replay_rules.md` | 回放格式依赖确定性哈希和种子管理 |
| `docs/01-architecture/battle_fsm_design.md` | FSM 状态转换依赖确定性执行 |
| `docs/01-architecture/schedules_design.md` | 系统执行顺序是确定性的基础 |
| `docs/02-domain/turn_rules.md` | 行动队列排序必须确定性 |
| `docs/02-domain/battle_rules.md` | Effect Pipeline 执行必须确定性 |
| `docs/01-architecture/README.md` | 效果管线、属性系统的确定性要求 |
| `docs/01-architecture/events_audit_design.md` | 领域事件白名单（宪法 2.2.7）管理所有正式领域事件 |
