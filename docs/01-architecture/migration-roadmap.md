---
id: 01-architecture.migration-roadmap
...
> ⚠️ **宪法 §1.1.7 提醒**：Tools 层按需实现，仅在内容量增长到人工审查不可行时启动。参见 `docs/01-architecture/tools_architecture.md` 的实现路线。
...
**文档同步要求**：
- 每 Phase 完成后必须更新 `docs/01-architecture/README.md` 中的目录结构说明
