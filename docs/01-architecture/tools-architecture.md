...
交叉引用：
- `docs/01-architecture/project-structure.md` — tools/ 目录结构参考
- `docs/01-architecture/layer-contracts.md` — 第七层 Tools 定义
...
> 交叉引用：`docs/01-architecture/content-pipeline.md`（数据驱动架构）、`docs/01-architecture/validation_rules.md` §10（启动时校验）
