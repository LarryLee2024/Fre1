---
id: 01-architecture.feature-flag-design
title: Feature Flag Design
status: draft
owner: architect
created: 2026-06-14
updated: 2026-06-14
...
交叉引用：`docs/01-architecture/00-overview/layer-contracts.md`、`docs/01-architecture/00-overview/project-structure.md`、`docs/01-architecture/09-infrastructure-migration/infrastructure-design.md`
