...
详细设计见 `docs/01-architecture/app-bootstrap.md` 和 `docs/01-architecture/plugin-design.md`。
...
详细设计见 `docs/01-architecture/infrastructure-design.md`。
...
详细设计见 `docs/01-architecture/modding-design.md`。
...
参照 `docs/01-architecture/error-architecture.md` 完整规范。此处简述：
...
🟥 **GameResult 不应定义在 shared/ 层**。详见 `docs/01-architecture/error-architecture.md` 迁移计划。每层定义自己的 Result 别名：
