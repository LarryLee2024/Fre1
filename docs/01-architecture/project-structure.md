...
|--------------|-------------|------------------------|---------------------|---------|
| `content/skills/*.ron` | `SkillDef` | `content/skills/skill_content.rs` | `SkillRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/buffs/*.ron` | `BuffDef` | `content/buffs/buff_content.rs` | `BuffRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/characters/*.ron` | `UnitTemplate` | `content/characters/character_content.rs` | `UnitRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/stages/*.ron` | `StageDef` | `content/stages/stage_content.rs` | `StageRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/terrains/*.ron` | `TerrainDef` | `content/terrains/terrain_content.rs` | `TerrainRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/items/*.ron` | `ItemDef` | `content/items/item_content.rs` | `ItemRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/equipments/*.ron` | `EquipmentDef` | `content/equipments/equipment_content.rs` | `EquipmentRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/classes/*.ron` | `ClassDef` | `content/classes/class_content.rs` | `ClassRegistry` | `docs/01-architecture/content-pipeline.md` |
| `content/ai_behaviors/*.ron` | `AiBehaviorDef` | `content/ai_behaviors/ai_behavior_content.rs` | `AiBehaviorRegistry` | `docs/01-architecture/content-pipeline.md` |
...
- 🟩 **加载模块遵循 `加载 → 校验 → 注册` 三步模式** — 详见 `docs/01-architecture/content-pipeline.md` 〔宪法 12.1.1〕
