---
id: 01-architecture.app-bootstrap
title: App Bootstrap
status: draft
owner: architect
created: 2026-06-14
...
> Version: 1.1
> Status: Proposed
> 来源：`docs/其他/30.md` 第983-1008行（App层）、`docs/01-architecture/README.md`（七层架构）、`docs/01-architecture/00-overview/layer-contracts.md`（App层合约）
...
| `docs/01-architecture/README.md` | 七层架构总览、依赖规则、插件注册顺序 |
| `docs/01-architecture/00-overview/layer-contracts.md` | App 层完整合约（第36-79行） |
| `docs/01-architecture/00-overview/project-structure.md` | App 目录结构（第70-78行） |
| `docs/01-architecture/00-overview/plugin-design.md` | Plugin 组织与注册详细设计 |
