...
来源：`docs/其他/30.md` 架构提炼、`docs/01-architecture/layer-contracts.md`、`docs/01-architecture/error-architecture.md`
...
错误架构详细规则见 `docs/01-architecture/error-architecture.md`。
...
- `docs/01-architecture/layer-contracts.md` — 层间契约
- `docs/01-architecture/error-architecture.md` — 错误体系架构
- `docs/01-architecture/project-structure.md` — 项目目录结构
- `docs/其他/30.md` — 架构提炼原始文档
- `docs/01-architecture/content-pipeline.md` — 内容管线
- `docs/01-architecture/migration-roadmap.md` — 迁移路线图
