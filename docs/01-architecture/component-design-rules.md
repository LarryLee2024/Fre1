...
Related: `docs/01-architecture/README.md` ECS 章节、`docs/01-architecture/layer-contracts.md`
...
| `docs/01-architecture/layer-contracts.md` | 组件应归属正确的业务模块 |
| `docs/02-domain/ecs_communication_rules.md` | 组件通信方式（Hook、Observer、Message） |
| `docs/01-architecture/plugin-design.md` | 组件通过 Plugin 注册 |
