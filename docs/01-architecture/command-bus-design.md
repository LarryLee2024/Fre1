...
> ActionQueue 作为 Effect Pipeline 的执行容器，确保效果的顺序解析。详见 `docs/01-architecture/skill-buff-abstraction.md` §ActionQueue。
...
| 文档 | 关系 |
|------|------|
| `docs/01-architecture/skill-buff-abstraction.md` | Effect Pipeline 集成、ActionQueue 设计 |
