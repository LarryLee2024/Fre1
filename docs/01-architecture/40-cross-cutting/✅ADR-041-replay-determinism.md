...
```rust
/// ✅ 正确：通过统一 RNG 服务
fn roll_crit(mut rng: ResMut<DeterministicRng>, crit_chance: f32) -> bool {
...
pub struct ReplayRecorder {
    ...
    pub checkpoint_interval: u32,    // 每多少帧记录一次校验和
}
...
impl Plugin for ReplayPlugin {
    fn build(&self, app: &mut App) {
        app.init_resource::<ReplayRecorder>()
           ...
           .add_systems(PostUpdate, recording_frame_bookend_system);
    }
}
```
...
src/infra/replay/
  ...
  ├── systems.rs             — frame_counter_system, recording_frame_bookend_system, playback_frame_bookend_system, rng_sync_system
