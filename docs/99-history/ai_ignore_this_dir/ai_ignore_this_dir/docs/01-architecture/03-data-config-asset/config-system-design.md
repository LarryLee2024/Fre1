---
id: 01-architecture.config-system-design
title: Config System Design
status: draft
owner: architect
created: 2026-06-14
updated: 2026-06-14
...
交叉引用：
- `docs/01-architecture/09-infrastructure-migration/infrastructure-design.md` — Infrastructure 层 config 模块设计
- `docs/01-architecture/README.md` — 数据驱动总纲（配置三级分离）
- `docs/01-architecture/03-data-config-asset/content-pipeline.md` — 内容管线（Definition 加载）
