---
status: partial
superseded: 2026-06-22 (P0 4→0 fixed: TurnQueue/BattlePhase queries + hardcoded text resolved; root factory partially fixed; P1/P2 items remain open)
type: review
...
**评估结果：部分通过（P0 已修复：TurnQueue/BattlePhase 查询改用 UiStore，硬编码文本改用本地化 key。根工厂部分修复：已改为 spawn_panel 只是仍覆盖 Node。P1/P2 项目按计划跟进。）**
