...
交叉引用：
- `docs/01-architecture/09-infrastructure-migration/migration-roadmap.md` — 项目架构迁移（不同于此文档的存档数据迁移）
- `docs/01-architecture/09-infrastructure-migration/infrastructure-design.md` — persistence 模块设计
