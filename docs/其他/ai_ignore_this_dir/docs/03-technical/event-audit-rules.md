---
id: 03-technical.event-audit-rules
title: Event Audit Rules
status: draft
...
Version: 1.1
Status: Proposed
> **优化来源**: `docs/01-architecture/events_audit_design.md`（吸收 50.md、34.md、74借鉴.md §4/§8/§22：废除 DomainEvent 大枚举、GameplayCue、双轨制、Observer/Trigger、EventOrd、反膨胀流式写入、S-tier 优先级）
...
> **优化来源**: `docs/01-architecture/events_audit_design.md`
...
> **优化来源**: `docs/01-architecture/events_audit_design.md` §8
...
> **优化来源**: `docs/01-architecture/events_audit_design.md` §4
...
> **优化来源**: `docs/01-architecture/events_audit_design.md` §34.md
