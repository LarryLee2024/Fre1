---
id: 03-technical.shared-layer-rules
title: Shared Layer Rules
status: draft
...
> **优化来源**: `docs/01-architecture/ids_design.md` — IdParseError、define_id! 宏、存档稳定性
...
> **优化来源**: `docs/01-architecture/ids_design.md` — Phase 2 后裸 Entity 编译报错
...
> **优化来源**: `docs/01-architecture/ids_design.md` § ID 在存档文件中的稳定性
...
> **优化来源**: `docs/01-architecture/ids_design.md` — define_id! 宏、IdParseError 统一
...
> **优化来源**: `docs/01-architecture/ids_design.md` — Strong ID Non-negotiable
...
> **优化来源**: `docs/01-architecture/ids_design.md` § 性能优化：高频 ID 预计算哈希缓存
...
> **优化来源**: `docs/01-architecture/ids_design.md` § 版本迁移兼容
...
> **优化来源**: `docs/01-architecture/ids_design.md` § MOD ID 前缀全局唯一性校验
...
> **优化来源**: `docs/01-architecture/ids_design.md` § 测试规范
