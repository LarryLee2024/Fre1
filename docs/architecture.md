...
> 本文件是架构规范的最高优先级文档。`docs/architecture/` 目录下 36 个子文件提供各领域的详细设计，以下索引列出所有子文件及其核心内容摘要。
...
详见 `docs/architecture/migration-roadmap.md`。
...
详见 `docs/architecture/app-bootstrap.md` 和 `docs/architecture/plugin-design.md`。
...
详见 `docs/architecture/plugin_contract_rules.md`。
...
详见 `docs/architecture/component_design_rules.md`。
...
详见 `docs/architecture/system_design_rules.md`。
...
> 当前 RON 配置数据存放在 `assets/` 目录下（过渡期），最终应迁移到 `content/` 目录（参见 `docs/architecture/migration-roadmap.md` Phase 4）。`assets/definitions/` 和 `assets/rules/` 中的引擎配置是过渡产物。
...
详见 `docs/architecture/ids_design.md`。
...
详见 `docs/architecture/determinism_rules.md`。
...
详见 `docs/architecture/performance_budget.md`。
...
详见 `docs/architecture/logging_design.md`。
...
详见 `docs/architecture/events_audit_design.md`。
...
详见 `docs/architecture/command_bus_design.md`。
...
详见 `docs/architecture/config_system_design.md`。
...
详见 `docs/architecture/content_data_format.md`。
...
详见 `docs/architecture/validation_rules.md`。
...
详见 `docs/architecture/save_migration_rules.md`。
...
详见 `docs/architecture/content_migration_design.md`。
...
详见 `docs/architecture/asset_lifecycle_rules.md`。
...
详见 `docs/architecture/asset_namespace_design.md`。
...
详见 `docs/architecture/battle_fsm_design.md`。
...
详见 `docs/architecture/skill-buff-abstraction.md`。
...
详见 `docs/architecture/pathfinding_design.md`。
...
详见 `docs/architecture/i18n_design.md`。
...
详见 `docs/architecture/tools_architecture.md`。
...
详见 `docs/architecture/testing_architecture.md`。
...
详见 `docs/architecture/ui_domain_boundary_rules.md`。
