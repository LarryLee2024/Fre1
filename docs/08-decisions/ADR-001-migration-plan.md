...
- `docs/01-architecture/layer-contracts.md` — 各层边界定义
- `docs/01-architecture/error-architecture.md` — 三层错误模型
- `docs/01-architecture/content-pipeline.md` — Content/Core 分离
- `docs/01-architecture/plugin-design.md` — Plugin 注册顺序
