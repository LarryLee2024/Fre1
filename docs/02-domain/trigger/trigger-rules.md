...
| 回合内调度时序（含 ExecutionStack） | `docs/01-architecture/battle-fsm-design.md` §4.5 |
...
| ExecutionStack 完整设计 | `docs/01-architecture/skill-buff-abstraction.md` §4.8.1 |
| TriggerRegistry 完整设计 | `docs/01-architecture/skill-buff-abstraction.md` §4.8.2 |
