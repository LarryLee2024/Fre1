...
三步执行的标准化效果处理管线。详见 `docs/01-architecture/01-battle-gas/skill-buff-abstraction.md` §3 和 `docs/02-domain/attribute-modifier/attribute-modifier-rules.md` 效果管线章节。
