...
Version: 1.0
Status: Proposed
Source: `docs/01-architecture/01-battle-gas/skill-buff-abstraction.md` §4.9、`docs/08-decisions/ADR-023-标签系统架构重整.md`、`docs/08-decisions/ADR-015-技能标签与分类体系.md`
...
| 标签在技能/Buff 中的使用 | `docs/01-architecture/01-battle-gas/skill-buff-abstraction.md` §4.9 |
