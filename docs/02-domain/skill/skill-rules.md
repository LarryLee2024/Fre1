...
参见：
- `docs/02-domain/requirement_rules.md` — 技能释放的前提条件系统
- `docs/02-domain/cost_rules.md` — 技能的消耗统一管理系统
- `docs/02-domain/selector_rules.md` — 技能的目标选择器系统
...
- 具体条件逻辑评估（由 `docs/02-domain/condition_rules.md` 负责）
- 具体消耗校验和扣除（由 `docs/02-domain/cost_rules.md` 负责）
- 目标坐标到实体列表的解析（由 `docs/02-domain/selector_rules.md` 负责）
- 释放前提的逐条验证（由 `docs/02-domain/requirement_rules.md` 负责）
