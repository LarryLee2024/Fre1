...
来源：`docs/其他/30.md` 架构提炼、`docs/architecture/layer-contracts.md`、`docs/architecture/error-architecture.md`
...
- `docs/architecture.md` — 七层架构总纲（最高优先级）
- `docs/architecture/layer-contracts.md` — 层间契约
- `docs/architecture/error-architecture.md` — 错误体系架构
- `docs/architecture/project-structure.md` — 项目目录结构
- `docs/其他/30.md` — 架构提炼原始文档
- `docs/architecture/content-pipeline.md` — 内容管线
