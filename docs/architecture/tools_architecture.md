...
交叉引用：
- `docs/architecture/project-structure.md` — tools/ 目录结构参考
- `docs/architecture/layer-contracts.md` — 第七层 Tools 定义
- `docs/architecture/save_migration_rules.md` — 存档迁移（区别于内容迁移）
- `docs/architecture/content_migration_design.md` — 内容格式迁移
...
> 交叉引用：`docs/architecture/content-pipeline.md`（数据驱动架构）、`docs/architecture/validation_rules.md` §10（启动时校验）
