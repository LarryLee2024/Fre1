...
- 人类 Override AI 决策时，必须在 `docs/adr/` 中记录一条"破例 ADR"，说明为什么绕过 AI
...
> **注意**：以下目录结构对应七层架构迁移目标（参见 `docs/architecture/migration-roadmap.md`）。当前项目仍为 Feature First 顶层结构，迁移完成后此表生效。
