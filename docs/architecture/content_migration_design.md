...
交叉引用：
- `docs/architecture/save_migration_rules.md` — 存档迁移（区别于本文档的内容迁移）
- `docs/architecture/project-structure.md` — content/ 目录结构
- `docs/architecture/migration-roadmap.md` — 项目架构迁移（区别于本文档的内容数据迁移）
- `docs/architecture/tools_architecture.md` — migration_tool 工具
