...
来源：`docs/其他/32.国际化.md`、`docs/其他/33..md`、`docs/其他/52.md`、`docs/architecture/infrastructure-design.md`、`docs/architecture/content-pipeline.md`、`docs/architecture/modding-design.md`
...
参见 `docs/architecture/content-pipeline.md` § Rule/Content 分离。
