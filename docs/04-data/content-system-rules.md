---
id: 04-data.content-system-rules
title: Content System Rules
status: draft
...
> **优化来源**: `docs/01-architecture/content_data_format.md` §阶段式加载架构 — 解决 Bevy Asset 系统的校验断层
...
> **优化来源**: `docs/01-architecture/content_data_format.md` §2 — 彻底杜绝 MOD 内容冲突
...
> **优化来源**: `docs/01-architecture/content_data_format.md` §字符串 ID 驻留 — 运行时 HashMap 热路径性能提升 10 倍以上
...
> **优化来源**: `docs/01-architecture/content_data_format.md` §MOD 冲突解决协议
...
> **优化来源**: `docs/01-architecture/content_data_format.md` §字段级审计
...
> **优化来源**: `docs/01-architecture/content_data_format.md` §曲线表配置
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §致命异步时序错误修正
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §加载进度屏障
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §Definition 即数据资产
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §Scene 模式
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §ScriptableObject 模式的 Bevy 实现
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §统一注册中心
...
> **优化来源**: `docs/01-architecture/content_data_format.md` — RON 配置文件契约
...
> **优化来源**: `docs/01-architecture/content-pipeline.md` §致命异步时序错误修正 + §阶段式加载架构
