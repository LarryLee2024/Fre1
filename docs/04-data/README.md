...
│   └── cue_schema.md
│
├── infrastructure/                  # 基础设施 Schema (3 domains)
│   ├── registry_schema.md
│   ├── pipeline_schema.md
│   └── replay_schema.md
│
...
| `foundation/id_strategy.md` | ⬜ pending | data-architect | — |
| `foundation/save_architecture.md` | ⬜ pending | data-architect | — |
| `foundation/replay_architecture.md` | ⬜ pending | data-architect | — |
...
| `capabilities/effect_schema.md` | ✅ stable | data-architect | 2026-06-16 |
...
| `domains/combat_schema.md` | ✅ stable | data-architect | 2026-06-16 |
