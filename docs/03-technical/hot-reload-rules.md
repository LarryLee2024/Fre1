---
id: 03-technical.hot-reload-rules
title: Hot Reload Rules
status: draft
...
> **优化来源**: docs/01-architecture/config_system_design.md §4.1
...
> **优化来源**: docs/01-architecture/config_system_design.md §2.2
