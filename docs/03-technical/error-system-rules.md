---
id: 03-technical.error-system-rules
title: Error System Rules
status: draft
...
Version: 1.1
Status: Proposed
> **优化来源**: `docs/01-architecture/error-architecture.md`（吸收 49.md 内容：GameErrorEvent、Port/Adapter、GameResult 重定位、thiserror vs miette、RuleFailure 物理分离）
...
> **优化来源**: `docs/01-architecture/error-architecture.md`
...
- 只用于基础设施层代码的统一错误处理
- 与 `docs/01-architecture/error-architecture.md` 保持一致
