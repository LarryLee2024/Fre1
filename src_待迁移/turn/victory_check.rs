...
mod tests {
    use super::*;
    use crate::map::{ConditionParamsDef, LoseConditionDef, VictoryConditionDef, WinConditionDef};
    ...
    use crate::character::{Dead, Unit, UnitId};
    use crate::map::LevelConfig;
    use crate::turn::order::TurnState;
