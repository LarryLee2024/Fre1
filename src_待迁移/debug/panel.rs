...
fn render_content(
    ...
    battle_record: &crate::battle::BattleRecord,
    turn_order: &crate::turn::TurnOrder,
    combat_intent: &crate::battle::CombatIntent,
    terrain_grid: &crate::map::runtime::TerrainGrid,
    terrain_registry: &crate::map::TerrainRegistry,
    occupancy: &crate::map::runtime::OccupancyGrid,
